...
timeperiod = 0:1:200; y0 = [3.48603 0.716788 5.08040];
...
figure (1) %help
hold off
plot(t,y13(:,1)), title('Change in Cm: +30% step in blue, -30% step in red')
hold on
plot(t,y07(:,1))

figure(2)
hold off
plot(t,y13(:,2)), title('Change in Ce: +30% step in blue, -30% step in red')
hold on
plot(t,y07(:,2))

figure(3)
hold off
plot(t,y13(:,3)), title('Change in Cg: +30% step in blue, -30% step in red')
hold on
plot(t,y07(:,3))

timeperiod = 0:0.1:200; y0 = [3.48603 0.716788 5.08040 10];
...
figure (4) %help
hold off
plot(t, y13lin(:,1)), title('Linearized change in Cm: +30% blue, -30% red')
hold on
plot(t, y07lin(:,1))

figure (5) %help
hold off
plot(t, y13lin(:,2)), title('Linearized change in Ce: +30% blue, -30% red')
hold on
plot(t, y07lin(:,2))

figure (6) %help
hold off
plot(t, y13lin(:,3)), title('Linearized change in Cg: +30% blue, -30% red')
hold on
plot(t, y07lin(:,3))

figure(7)   % Test graph to see if y(4) = Cgin is at the correct value
hold off
plot(t, y13lin(:,4)), title('Cgin')
hold on
plot(t, y07lin(:,4))
